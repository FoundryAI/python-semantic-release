...
- Include additional changes in release commits
  ([`3e34f95`](https://github.com/FoundryAI/python-semantic-release/commit/3e34f957ff5a3ec6e6f984cc4a79a38ce4391ea9))
...
- Support Github Enterprise server
  ([`b4e01f1`](https://github.com/FoundryAI/python-semantic-release/commit/b4e01f1b7e841263fa84f57f0ac331f7c0b31954))

- **parser_angular**: Allow customization in parser
  ([`298eebb`](https://github.com/FoundryAI/python-semantic-release/commit/298eebbfab5c083505036ba1df47a5874a1eed6e))
...
- Use gitlab-ci or github actions env vars
  ([`8ca8dd4`](https://github.com/FoundryAI/python-semantic-release/commit/8ca8dd40f742f823af147928bd75a9577c50d0fd))
...
- Rewrite Twine adapter for uploading to artifact repositories
  ([`cfb20af`](https://github.com/FoundryAI/python-semantic-release/commit/cfb20af79a8e25a77aee9ff72deedcd63cb7f62f))
...
- Allow custom environment variable names
  ([#392](https://github.com/FoundryAI/python-semantic-release/pull/392),
  [`372cda3`](https://github.com/FoundryAI/python-semantic-release/commit/372cda3497f16ead2209e6e1377d38f497144883))
...
- Custom git tag format support
  ([#373](https://github.com/FoundryAI/python-semantic-release/pull/373),
  [`1d76632`](https://github.com/FoundryAI/python-semantic-release/commit/1d76632043bf0b6076d214a63c92013624f4b95e))
...
- Add support for non-prefixed tags
  ([#366](https://github.com/FoundryAI/python-semantic-release/pull/366),
  [`0fee4dd`](https://github.com/FoundryAI/python-semantic-release/commit/0fee4ddb5baaddf85ed6b76e76a04474a5f97d0a))

- **parser**: Add scipy style parser
  ([#369](https://github.com/FoundryAI/python-semantic-release/pull/369),
  [`51a3921`](https://github.com/FoundryAI/python-semantic-release/commit/51a39213ea120c4bbd7a57b74d4f0cc3103da9f5))

- Add option to omit tagging ([#341](https://github.com/FoundryAI/python-semantic-release/pull/341),
  [`20603e5`](https://github.com/FoundryAI/python-semantic-release/commit/20603e53116d4f05e822784ce731b42e8cbc5d8f))

- Allow the use of .pypirc for twine uploads
  ([#325](https://github.com/FoundryAI/python-semantic-release/pull/325),
  [`6bc56b8`](https://github.com/FoundryAI/python-semantic-release/commit/6bc56b8aa63069a25a828a2d1a9038ecd09b7d5d))

- **checks**: Add support for Jenkins CI
  ([#322](https://github.com/FoundryAI/python-semantic-release/pull/322),
  [`3e99855`](https://github.com/FoundryAI/python-semantic-release/commit/3e99855c6bc72b3e9a572c58cc14e82ddeebfff8))
...
- Support toml files for version declaration
  ([#307](https://github.com/FoundryAI/python-semantic-release/pull/307),
  [`9b62a7e`](https://github.com/FoundryAI/python-semantic-release/commit/9b62a7e377378667e716384684a47cdf392093fa))
...
- **github**: Retry GitHub API requests on failure
  ([#314](https://github.com/FoundryAI/python-semantic-release/pull/314),
  [`ac241ed`](https://github.com/FoundryAI/python-semantic-release/commit/ac241edf4de39f4fc0ff561a749fa85caaf9e2ae))
...
- **print-version**: Add print-version command to output version
  ([`512e3d9`](https://github.com/FoundryAI/python-semantic-release/commit/512e3d92706055bdf8d08b7c82927d3530183079))
...
- **build**: Allow falsy values for build_command to disable build step
  ([`c07a440`](https://github.com/FoundryAI/python-semantic-release/commit/c07a440f2dfc45a2ad8f7c454aaac180c4651f70))

- **hvcs**: Add hvcs_domain config option
  ([`ab3061a`](https://github.com/FoundryAI/python-semantic-release/commit/ab3061ae93c49d71afca043b67b361e2eb2919e6))
...
- **repository**: Add to settings artifact repository
  ([`f4ef373`](https://github.com/FoundryAI/python-semantic-release/commit/f4ef3733b948282fba5a832c5c0af134609b26d2))
...
- Add `upload_to_pypi_glob_patterns` option
  ([`42305ed`](https://github.com/FoundryAI/python-semantic-release/commit/42305ed499ca08c819c4e7e65fcfbae913b8e6e1))

- **changelog**: Add PR links in markdown
  ([#282](https://github.com/FoundryAI/python-semantic-release/pull/282),
  [`0448f6c`](https://github.com/FoundryAI/python-semantic-release/commit/0448f6c350bbbf239a81fe13dc5f45761efa7673))
...
- Add `major_on_zero` option
  ([`d324154`](https://github.com/FoundryAI/python-semantic-release/commit/d3241540e7640af911eb24c71e66468feebb0d46))

To control if bump major or not when current major version is zero.

- **logs**: Include scope in changelogs
  ([#281](https://github.com/FoundryAI/python-semantic-release/pull/281),
  [`21c96b6`](https://github.com/FoundryAI/python-semantic-release/commit/21c96b688cc44cc6f45af962ffe6d1f759783f37))
...
- Add changelog_capitalize configuration
  ([`7cacca1`](https://github.com/FoundryAI/python-semantic-release/commit/7cacca1eb436a7166ba8faf643b53c42bc32a6a7))
...
- **parser-scipy**: Increase speed & decrease complexity of commit parsing
  ([`2b661ed`](https://github.com/FoundryAI/python-semantic-release/commit/2b661ed122a6f0357a6b92233ac1351c54c7794e))

- **parser-emoji**: Increase speed of commit parsing
  ([`2c9c468`](https://github.com/FoundryAI/python-semantic-release/commit/2c9c4685a66feb35cd78571cf05f76344dd6d66a))

- **parser-angular**: Simplify commit parsing type pre-calculation
  ([`a86a28c`](https://github.com/FoundryAI/python-semantic-release/commit/a86a28c5e26ed766cda71d26b9382c392e377c61))

- Improve git history processing for changelog generation
  ([#972](https://github.com/FoundryAI/python-semantic-release/pull/972),
  [`bfda159`](https://github.com/FoundryAI/python-semantic-release/commit/bfda1593af59e9e728c584dd88d7927fc52c879f))
...
- **algorithm**: Simplify logs & use lookup when searching for commit & tag match
  ([`3690b95`](https://github.com/FoundryAI/python-semantic-release/commit/3690b9511de633ab38083de4d2505b6d05853346))

- **algorithm**: Refactor bfs search to use queue rather than recursion
  ([`8b742d3`](https://github.com/FoundryAI/python-semantic-release/commit/8b742d3db6652981a7b5f773a74b0534edc1fc15))
...
- Fix docstring
  ([`5a5e2cf`](https://github.com/FoundryAI/python-semantic-release/commit/5a5e2cfb5e6653fb2e95e6e23e56559953b2c2b4))
...
- Generate `changelog.md` file
  ([#266](https://github.com/FoundryAI/python-semantic-release/pull/266),
  [`2587dfe`](https://github.com/FoundryAI/python-semantic-release/commit/2587dfed71338ec6c816f58cdf0882382c533598))
...
- Add required to inputs in action metadata
  ([#264](https://github.com/FoundryAI/python-semantic-release/pull/264),
  [`e76b255`](https://github.com/FoundryAI/python-semantic-release/commit/e76b255cf7d3d156e3314fc28c54d63fa126e973))
...
- Use range for toml dependency
  ([`45707e1`](https://github.com/FoundryAI/python-semantic-release/commit/45707e1b7dcab48103a33de9d7f9fdb5a34dae4a))
...
- Support multiline version_pattern matching by default
  ([`82f7849`](https://github.com/FoundryAI/python-semantic-release/commit/82f7849dcf29ba658e0cb3b5d21369af8bf3c16f))

### Documentation

- Link to getting started guide in README
  ([`f490e01`](https://github.com/FoundryAI/python-semantic-release/commit/f490e0194fa818db4d38c185bc5e6245bfde546b))

- Create 'getting started' instructions
  ([#256](https://github.com/FoundryAI/python-semantic-release/pull/256),
  [`5f4d000`](https://github.com/FoundryAI/python-semantic-release/commit/5f4d000c3f153d1d23128acf577e389ae879466e))
...
- **changelog**: Send changelog to stdout
  ([`87e2bb8`](https://github.com/FoundryAI/python-semantic-release/commit/87e2bb881387ff3ac245ab9923347a5a616e197b))
...
- Add quotation marks to the pip commands in CONTRIBUTING.rst
  ([#253](https://github.com/FoundryAI/python-semantic-release/pull/253),
  [`e20fa43`](https://github.com/FoundryAI/python-semantic-release/commit/e20fa43098c06f5f585c81b9cd7e287dcce3fb5d))
...
- Commit all files with bumped versions
  ([#249](https://github.com/FoundryAI/python-semantic-release/pull/249),
  [`b3a1766`](https://github.com/FoundryAI/python-semantic-release/commit/b3a1766be7edb7d2eb76f2726d35ab8298688b3b))

### Documentation

- Give example of multiple build commands
  ([#248](https://github.com/FoundryAI/python-semantic-release/pull/248),
  [`65f1ffc`](https://github.com/FoundryAI/python-semantic-release/commit/65f1ffcc6cac3bf382f4b821ff2be59d04f9f867))
...
- Bump versions in multiple files
  ([#246](https://github.com/FoundryAI/python-semantic-release/pull/246),
  [`0ba2c47`](https://github.com/FoundryAI/python-semantic-release/commit/0ba2c473c6e44cc326b3299b6ea3ddde833bdb37))
...
- **changelog**: Swap sha and message in table changelog
  ([`6741370`](https://github.com/FoundryAI/python-semantic-release/commit/6741370ab09b1706ff6e19b9fbe57b4bddefc70d))
...
- **changelog**: Add changelog_table component
  ([#242](https://github.com/FoundryAI/python-semantic-release/pull/242),
  [`fe6a7e7`](https://github.com/FoundryAI/python-semantic-release/commit/fe6a7e7fa014ffb827a1430dbcc10d1fc84c886b))
...
- Add conda-forge badge
  ([`e9536bb`](https://github.com/FoundryAI/python-semantic-release/commit/e9536bbe119c9e3b90c61130c02468e0e1f14141))

### Features

- **changelog**: Add changelog components
  ([#240](https://github.com/FoundryAI/python-semantic-release/pull/240),
  [`3e17a98`](https://github.com/FoundryAI/python-semantic-release/commit/3e17a98d7fa8468868a87e62651ac2c010067711))
...
- Convert \r\n to \n in commit messages
  ([`34acbbc`](https://github.com/FoundryAI/python-semantic-release/commit/34acbbcd25320a9d18dcd1a4f43e1ce1837b2c9f))
...
- **history**: Create emoji parser
  ([#238](https://github.com/FoundryAI/python-semantic-release/pull/238),
  [`2e1c50a`](https://github.com/FoundryAI/python-semantic-release/commit/2e1c50a865628b372f48945a039a3edb38a7cdf0))
...
- Use getboolean for commit_version_number
  ([`a60e0b4`](https://github.com/FoundryAI/python-semantic-release/commit/a60e0b4e3cadf310c3e0ad67ebeb4e69d0ee50cb))
...
- Rewrite commit-log-parsing.rst
  ([`4c70f4f`](https://github.com/FoundryAI/python-semantic-release/commit/4c70f4f2aa3343c966d1b7ab8566fcc782242ab9))

- Document compare_link option
  ([`e52c355`](https://github.com/FoundryAI/python-semantic-release/commit/e52c355c0d742ddd2cfa65d42888296942e5bec5))

### Features

- **history**: Support linking compare page in changelog
  ([`79a8e02`](https://github.com/FoundryAI/python-semantic-release/commit/79a8e02df82fbc2acecaad9e9ff7368e61df3e54))
...
- Add = to verbosity option
  ([`a0f4c9c`](https://github.com/FoundryAI/python-semantic-release/commit/a0f4c9cd397fcb98f880097319c08160adb3c3e6))

Fixes #227

- Use references where possible
  ([`f38e5d4`](https://github.com/FoundryAI/python-semantic-release/commit/f38e5d4a1597cddb69ce47a4d79b8774e796bf41))
...
- **history**: Check all paragraphs for breaking changes
  ([`fec08f0`](https://github.com/FoundryAI/python-semantic-release/commit/fec08f0dbd7ae15f95ca9c41a02c9fe6d448ede0))
...
- Add documentation for PYPI_TOKEN
  ([`a8263a0`](https://github.com/FoundryAI/python-semantic-release/commit/a8263a066177d1d42f2844e4cb42a76a23588500))

### Features

- **actions**: Support PYPI_TOKEN on GitHub Actions
  ([`df2c080`](https://github.com/FoundryAI/python-semantic-release/commit/df2c0806f0a92186e914cfc8cc992171d74422df))
...
- **pypi**: Support easier use of API tokens
  ([`bac135c`](https://github.com/FoundryAI/python-semantic-release/commit/bac135c0ae7a6053ecfc7cdf2942c3c89640debf))
...
- **hvcs**: Convert get_hvcs to use LoggedFunction
  ([`3084249`](https://github.com/FoundryAI/python-semantic-release/commit/308424933fd3375ca3730d9eaf8abbad2435830b))
...
- Create Read the Docs config file
  ([`aa5a1b7`](https://github.com/FoundryAI/python-semantic-release/commit/aa5a1b700a1c461c81c6434686cb6f0504c4bece))

- Include README.rst in index.rst
  ([`8673a9d`](https://github.com/FoundryAI/python-semantic-release/commit/8673a9d92a9bf348bb3409e002a830741396c8ca))

These files were very similar so it makes sense to simply include one inside the other.

- Rewrite README.rst
  ([`e049772`](https://github.com/FoundryAI/python-semantic-release/commit/e049772cf14cdd49538cf357db467f0bf3fe9587))

- Move action.rst into main documentation
  ([`509ccaf`](https://github.com/FoundryAI/python-semantic-release/commit/509ccaf307a0998eced69ad9fee1807132babe28))

- Rewrite troubleshooting page
  ([`0285de2`](https://github.com/FoundryAI/python-semantic-release/commit/0285de215a8dac3fcc9a51f555fa45d476a56dff))

### Refactoring

- **debug**: Use logging and click_log instead of ndebug
  ([`15b1f65`](https://github.com/FoundryAI/python-semantic-release/commit/15b1f650f29761e1ab2a91b767cbff79b2057a4c))
...
- Automate API docs
  ([`7d4fea2`](https://github.com/FoundryAI/python-semantic-release/commit/7d4fea266cc75007de51609131eb6d1e324da608))
...
- **github**: Add tag as default release name
  ([`2997908`](https://github.com/FoundryAI/python-semantic-release/commit/2997908f80f4fcec56917d237a079b961a06f990))
...
- Update index.rst
  ([`b27c26c`](https://github.com/FoundryAI/python-semantic-release/commit/b27c26c66e7e41843ab29076f7e724908091b46e))

- Improve formatting of envvars page
  ([`b376a56`](https://github.com/FoundryAI/python-semantic-release/commit/b376a567bfd407a507ce0752614b0ca75a0f2973))

- Improve formatting of configuration page
  ([`9a8e22e`](https://github.com/FoundryAI/python-semantic-release/commit/9a8e22e838d7dbf3bfd941397c3b39560aca6451))

### Features

- **history**: Allow customizing changelog_sections
  ([#207](https://github.com/FoundryAI/python-semantic-release/pull/207),
  [`d5803d5`](https://github.com/FoundryAI/python-semantic-release/commit/d5803d5c1668d86482a31ac0853bac7ecfdc63bc))
...
- Bump dependencies and fix Windows issues on Development
  ([#173](https://github.com/FoundryAI/python-semantic-release/pull/173),
  [`0a6f8c3`](https://github.com/FoundryAI/python-semantic-release/commit/0a6f8c3842b05f5f424dad5ce1fa5e3823c7e688))
...
- **history**: Leave case of other characters unchanged
  ([`96ba94c`](https://github.com/FoundryAI/python-semantic-release/commit/96ba94c4b4593997343ec61ecb6c823c1494d0e2))
...
- Make action use current version of semantic-release
  ([`123984d`](https://github.com/FoundryAI/python-semantic-release/commit/123984d735181c622f3d99088a1ad91321192a11))
...
- Rename default of build_command config
  ([`d5db22f`](https://github.com/FoundryAI/python-semantic-release/commit/d5db22f9f7acd05d20fd60a8b4b5a35d4bbfabb8))

### Documentation

- **pypi**: Update docstings in pypi.py
  ([`6502d44`](https://github.com/FoundryAI/python-semantic-release/commit/6502d448fa65e5dc100e32595e83fff6f62a881a))

### Features

- **build**: Allow config setting for build command
  ([#195](https://github.com/FoundryAI/python-semantic-release/pull/195),
  [`740f4bd`](https://github.com/FoundryAI/python-semantic-release/commit/740f4bdb26569362acfc80f7e862fc2c750a46dd))
...
- Make AUTHORS.rst dynamic
  ([`db2e076`](https://github.com/FoundryAI/python-semantic-release/commit/db2e0762f3189d0f1a6ba29aad32bdefb7e0187f))

- **readme**: Fix minor typo
  ([`c22f69f`](https://github.com/FoundryAI/python-semantic-release/commit/c22f69f62a215ff65e1ab6dcaa8e7e9662692e64))

### Features

- **actions**: Create GitHub Action
  ([`350245d`](https://github.com/FoundryAI/python-semantic-release/commit/350245dbfb07ed6a1db017b1d9d1072b368b1497))
...
- Make commit message configurable
  ([#184](https://github.com/FoundryAI/python-semantic-release/pull/184),
  [`eb0762c`](https://github.com/FoundryAI/python-semantic-release/commit/eb0762ca9fea5cecd5c7b182504912a629be473b))
...
- **pypi**: Change bdist_wheels to bdist_wheel
  ([`c4db509`](https://github.com/FoundryAI/python-semantic-release/commit/c4db50926c03f3d551c8331932c567c7bdaf4f3d))
...
- **pypi**: Add build_commands config
  ([`22146ea`](https://github.com/FoundryAI/python-semantic-release/commit/22146ea4b94466a90d60b94db4cc65f46da19197))
...
- **git**: Add a new config for commit author
  ([`aa2c22c`](https://github.com/FoundryAI/python-semantic-release/commit/aa2c22c469448fe57f02bea67a02f998ce519ac3))
...
- Repair parsing of remotes in the gitlab ci format
  ([`0fddbe2`](https://github.com/FoundryAI/python-semantic-release/commit/0fddbe2fb70d24c09ceddb789a159162a45942dc))
...
- Support repository owner names containing dots
  ([`a6c4da4`](https://github.com/FoundryAI/python-semantic-release/commit/a6c4da4c0e6bd8a37f64544f7813fa027f5054ed))

Fixes #179

- **github**: Use application/octet-stream for .whl files
  ([`90a7e47`](https://github.com/FoundryAI/python-semantic-release/commit/90a7e476a04d26babc88002e9035cad2ed485b07))
...
- Upload distribution files to GitHub Releases
  ([#177](https://github.com/FoundryAI/python-semantic-release/pull/177),
  [`e427658`](https://github.com/FoundryAI/python-semantic-release/commit/e427658e33abf518191498c3142a0f18d3150e07))
...
- Only overwrite with patch if bump is None
  ([`1daa4e2`](https://github.com/FoundryAI/python-semantic-release/commit/1daa4e23ec2dd40c6b490849276524264787e24e))

Fixes #159

- Add more debug statements in logs
  ([`bc931ec`](https://github.com/FoundryAI/python-semantic-release/commit/bc931ec46795fde4c1ccee004eec83bf73d5de7a))

### Features

- **history**: Capitalize changelog messages
  ([`1a8e306`](https://github.com/FoundryAI/python-semantic-release/commit/1a8e3060b8f6d6362c27903dcfc69d17db5f1d36))
...
- **github**: Send token in request header
  ([`be9972a`](https://github.com/FoundryAI/python-semantic-release/commit/be9972a7b1fb183f738fb31bd370adb30281e4d5))
...
- Fix broken list in readme
  ([`7aa572b`](https://github.com/FoundryAI/python-semantic-release/commit/7aa572b2a323ddbc69686309226395f40c52b469))

Fix the syntax of a broken bullet-point list in README.rst.

- Add note about automatic releases in readme
  ([`e606e75`](https://github.com/FoundryAI/python-semantic-release/commit/e606e7583a30167cf7679c6bcada2f9e768b3abe))

- Update readme and getting started docs
  ([`07b3208`](https://github.com/FoundryAI/python-semantic-release/commit/07b3208ff64301e544c4fdcb48314e49078fc479))
...
- Remove erroneous submodule
  ([`762bfda`](https://github.com/FoundryAI/python-semantic-release/commit/762bfda728c266b8cd14671d8da9298fc99c63fb))

- **cli**: --noop flag works when before command
  ([`4fcc781`](https://github.com/FoundryAI/python-semantic-release/commit/4fcc781d1a3f9235db552f0f4431c9f5e638d298))
...
- **history**: Enable colon defined version
  ([`7837f50`](https://github.com/FoundryAI/python-semantic-release/commit/7837f5036269328ef29996b9ea63cccd5a6bc2d5))
...
- Add quotes around twine arguments
  ([`46a83a9`](https://github.com/FoundryAI/python-semantic-release/commit/46a83a94b17c09d8f686c3ae7b199d7fd0e0e5e5))
...
- **github**: Add check for GITHUB_ACTOR for git push
  ([#162](https://github.com/FoundryAI/python-semantic-release/pull/162),
  [`c41e9bb`](https://github.com/FoundryAI/python-semantic-release/commit/c41e9bb986d01b92d58419cbdc88489d630a11f1))

### Features

- **parser**: Make BREAKING-CHANGE synonymous with BREAKING CHANGE
  ([`beedccf`](https://github.com/FoundryAI/python-semantic-release/commit/beedccfddfb360aeebef595342ee980446012ec7))
...
- **parser**: Add support for exclamation point for breaking changes
  ([`a4f8a10`](https://github.com/FoundryAI/python-semantic-release/commit/a4f8a10afcc358a8fbef83be2041129480350be2))
...
- Fallback to whole log if correct tag is not available
  ([#157](https://github.com/FoundryAI/python-semantic-release/pull/157),
  [`252bffd`](https://github.com/FoundryAI/python-semantic-release/commit/252bffd3be7b6dfcfdb384d24cb1cd83d990fc9a))
...
- Set version of click to >=2.0,<8.0.
  ([#155](https://github.com/FoundryAI/python-semantic-release/pull/155),
  [`f07c7f6`](https://github.com/FoundryAI/python-semantic-release/commit/f07c7f653be1c018e443f071d9a196d9293e9521))
...
- Update regex to get repository owner and name for project with dots
  ([`2778e31`](https://github.com/FoundryAI/python-semantic-release/commit/2778e316a0c0aa931b1012cb3862d04659c05e73))
...
- Support repo urls without git terminator
  ([`700e9f1`](https://github.com/FoundryAI/python-semantic-release/commit/700e9f18dafde1833f482272a72bb80b54d56bb3))
...
- Update list of commit types to include build, ci and perf
  ([`41ea12f`](https://github.com/FoundryAI/python-semantic-release/commit/41ea12fa91f97c0046178806bce3be57c3bc2308))
...
- Manage subgroups in git remote url
  ([`4b11875`](https://github.com/FoundryAI/python-semantic-release/commit/4b118754729094e330389712cf863e1c6cefee69))
...
- Allow users to get version from tag and write/commit bump to file
  ([`1f9fe1c`](https://github.com/FoundryAI/python-semantic-release/commit/1f9fe1cc7666d47cc0c348c4705b63c39bf10ecc))
...
- Make the vcs functionalities work with gitlab
  ([`82d555d`](https://github.com/FoundryAI/python-semantic-release/commit/82d555d45b9d9e295ef3f9546a6ca2a38ca4522e))
...
- Allow the override of configuration options from cli
  ([`f0ac82f`](https://github.com/FoundryAI/python-semantic-release/commit/f0ac82fe59eb59a768a73a1bf2ea934b9d448c58))
...
- Add the possibility to load configuration from pyproject.toml
  ([`35f8bfe`](https://github.com/FoundryAI/python-semantic-release/commit/35f8bfef443c8b69560c918f4b13bc766fb3daa2))
...
- Remove deletion of build folder
  ([`b45703d`](https://github.com/FoundryAI/python-semantic-release/commit/b45703dad38c29b28575060b21e5fb0f8482c6b1))

Fixes #115

- Updated the tag tests
  ([`3303eef`](https://github.com/FoundryAI/python-semantic-release/commit/3303eefa49a0474bbd85df10ae186ccbf9090ec1))

- Kept setting new version for tag source
  ([`0e24a56`](https://github.com/FoundryAI/python-semantic-release/commit/0e24a5633f8f94b48da97b011634d4f9d84f7b4b))

- Add commit hash when generating breaking changes
  ([`0c74faf`](https://github.com/FoundryAI/python-semantic-release/commit/0c74fafdfa81cf2e13db8f4dcf0a6f7347552504))

Fixes #120

- Upgrade click to 7.0
  ([`2c5dd80`](https://github.com/FoundryAI/python-semantic-release/commit/2c5dd809b84c2157a5e6cdcc773c43ec864f0328))

### Features

- Add support for showing unreleased changelog
  ([`41ef794`](https://github.com/FoundryAI/python-semantic-release/commit/41ef7947ad8a07392c96c7540980476e989c1d83))

Fixes #134

- Add support for configuring branch
  ([`14abb05`](https://github.com/FoundryAI/python-semantic-release/commit/14abb05e7f878e88002f896812d66b4ea5c219d4))

Fixes #43

- Add configuration to customize handling of dists
  ([`2af6f41`](https://github.com/FoundryAI/python-semantic-release/commit/2af6f41b21205bdd192514a434fca2feba17725a))
...
- Make sure the history only breaks loop for version commit
  ([`5dc6cfc`](https://github.com/FoundryAI/python-semantic-release/commit/5dc6cfc634254f09997bb3cb0f17abd296e2c01f))

Fixes #135

- Correct isort build fail
  ([`0037210`](https://github.com/FoundryAI/python-semantic-release/commit/00372100b527ff9308d9e43fe5c65cdf179dc4dc))

build fail: https://circleci.com/gh/relekang/python-semantic-release/379

- **vcs**: Allow cli to be run from subdirectory
  ([`fb7bb14`](https://github.com/FoundryAI/python-semantic-release/commit/fb7bb14300e483626464795b8ff4f033a194cf6f))

### Documentation

- **circleci**: Point badge to master branch
  ([`9c7302e`](https://github.com/FoundryAI/python-semantic-release/commit/9c7302e184a1bd88f39b3039691b55cd77f0bb07))
...
- Debug usage and related
  ([`f08e594`](https://github.com/FoundryAI/python-semantic-release/commit/f08e5943a9876f2d17a7c02f468720995c7d9ffd))
...
- Correct usage of changelog
  ([`f4f59b0`](https://github.com/FoundryAI/python-semantic-release/commit/f4f59b08c73700c6ee04930221bfcb1355cbc48d))

- Describing the commands
  ([`b6fa04d`](https://github.com/FoundryAI/python-semantic-release/commit/b6fa04db3044525a1ee1b5952fb175a706842238))
...
- Update url for commit guidelinesThe guidelines can now be found in theDEVELOPERS.md in angular.
  ([`90c1b21`](https://github.com/FoundryAI/python-semantic-release/commit/90c1b217f86263301b91d19d641c7b348e37d960))
...
- Maintain version variable formatting on bump
  ([#103](https://github.com/FoundryAI/python-semantic-release/pull/103),
  [`bf63156`](https://github.com/FoundryAI/python-semantic-release/commit/bf63156f60340614fae94c255fb2f097cf317b2b))
...
- Initialize git Repo from current folder
  ([`c7415e6`](https://github.com/FoundryAI/python-semantic-release/commit/c7415e634c0affbe6396e0aa2bafe7c1b3368914))

This allows to run the program also from inner repository folders

- Use same changelog code for command as post
  ([`248f622`](https://github.com/FoundryAI/python-semantic-release/commit/248f62283c59182868c43ff105a66d85c923a894))
...
- **readme**: Add testing instructions
  ([`bb352f5`](https://github.com/FoundryAI/python-semantic-release/commit/bb352f5b6616cc42c9f2f2487c51dedda1c68295))

- Add installation instructions for development
  ([#106](https://github.com/FoundryAI/python-semantic-release/pull/106),
  [`9168d0e`](https://github.com/FoundryAI/python-semantic-release/commit/9168d0ea56734319a5d77e890f23ff6ba51cc97d))

### Features

- **ci_checks**: Add support for bitbucket
  ([`9fc120d`](https://github.com/FoundryAI/python-semantic-release/commit/9fc120d1a7e4acbbca609628e72651685108b364))
...
- Use correct syntax to exclude tests in package
  ([`3e41e91`](https://github.com/FoundryAI/python-semantic-release/commit/3e41e91c318663085cd28c8165ece21d7e383475))

This implements #92 without deleting __init__.py files.

- Filter out pypi secrets from exceptions
  ([`5918371`](https://github.com/FoundryAI/python-semantic-release/commit/5918371c1e82b06606087c9945d8eaf2604a0578))

Fixes #41

- Clean out dist and build before building
  ([`b628e46`](https://github.com/FoundryAI/python-semantic-release/commit/b628e466f86bc27cbe45ec27a02d4774a0efd3bb))
...
- Add better error message when pypi credentials are empty
  ([`c4e5dcb`](https://github.com/FoundryAI/python-semantic-release/commit/c4e5dcbeda0ce8f87d25faefb4d9ae3581029a8f))

Fixes #96

- Unfreeze dependencies
  ([`847833b`](https://github.com/FoundryAI/python-semantic-release/commit/847833bf48352a4935f906d0c3f75e1db596ca1c))
...
- **parser_angular**: Fix non-match when special chars in scope
  ([`8a33123`](https://github.com/FoundryAI/python-semantic-release/commit/8a331232621b26767e4268079f9295bf695047ab))

### Documentation

- Remove reference to gitter
  ([`896e37b`](https://github.com/FoundryAI/python-semantic-release/commit/896e37b95cc43218e8f593325dd4ea63f8b895d9))
...
- Add credentials check
  ([`0694604`](https://github.com/FoundryAI/python-semantic-release/commit/0694604f3b3d2159a4037620605ded09236cdef5))

- Add check of credentials
  ([`7d945d4`](https://github.com/FoundryAI/python-semantic-release/commit/7d945d44b36b3e8c0b7771570cb2305e9e09d0b2))

- Add dists to twine call
  ([`1cec2df`](https://github.com/FoundryAI/python-semantic-release/commit/1cec2df8bcb7f877c813d6470d454244630b050a))

- Re-add skip-existing
  ([`366e9c1`](https://github.com/FoundryAI/python-semantic-release/commit/366e9c1d0b9ffcde755407a1de18e8295f6ad3a1))

- Use twine through cli call
  ([`ab84beb`](https://github.com/FoundryAI/python-semantic-release/commit/ab84beb8f809e39ae35cd3ce5c15df698d8712fd))

- Use new interface for twine
  ([`c04872d`](https://github.com/FoundryAI/python-semantic-release/commit/c04872d00a26e9bf0f48eeacb360b37ce0fba01e))

- Remove repository argument in twine
  ([`e24543b`](https://github.com/FoundryAI/python-semantic-release/commit/e24543b96adb208897f4ce3eaab96b2f4df13106))

- Update twine
  ([`c4ae7b8`](https://github.com/FoundryAI/python-semantic-release/commit/c4ae7b8ecc682855a8568b247690eaebe62d2d26))

- Remove universal from setup config
  ([`18b2402`](https://github.com/FoundryAI/python-semantic-release/commit/18b24025e397aace03dd5bb9eed46cfdd13491bd))

- Remove support for python 2
  ([`85fe638`](https://github.com/FoundryAI/python-semantic-release/commit/85fe6384c15db317bc7142f4c8bbf2da58cece58))

BREAKING CHANGE: This will only work with python 3 after this commit.

- Change requests from fixed version to version range
  ([#93](https://github.com/FoundryAI/python-semantic-release/pull/93),
  [`af3ad59`](https://github.com/FoundryAI/python-semantic-release/commit/af3ad59f018876e11cc3acdda0b149f8dd5606bd))
...
- Add type hints and more complete docstrings
  ([`a6d5e9b`](https://github.com/FoundryAI/python-semantic-release/commit/a6d5e9b1ccbe75d59e7240528593978a19d8d040))
...
- Fix typo in documentation index
  ([`da6844b`](https://github.com/FoundryAI/python-semantic-release/commit/da6844bce0070a0020bf13950bd136fe28262602))
...
- Add support for commit_message config variable
  ([`4de5400`](https://github.com/FoundryAI/python-semantic-release/commit/4de540011ab10483ee1865f99c623526cf961bb9))
...
- **CI checks**: Add support for GitLab CI checks
  ([`8df5e2b`](https://github.com/FoundryAI/python-semantic-release/commit/8df5e2bdd33a620e683f3adabe174e94ceaa88d9))
...
- Upgrade twine
  ([`9722313`](https://github.com/FoundryAI/python-semantic-release/commit/9722313eb63c7e2c32c084ad31bed7ee1c48a928))
...
- Change Gitpython version number
  ([`23c9d4b`](https://github.com/FoundryAI/python-semantic-release/commit/23c9d4b6a1716e65605ed985881452898d5cf644))
...
- Add retry option to cli docs
  ([`021da50`](https://github.com/FoundryAI/python-semantic-release/commit/021da5001934f3199c98d7cf29f62a3ad8c2e56a))
...
- Make repo non if it is not a git repository
  ([`1dc306b`](https://github.com/FoundryAI/python-semantic-release/commit/1dc306b9b1db2ac360211bdc61fd815302d0014c))

Fixes #74

- Add pytest cache to gitignore
  ([`b8efd5a`](https://github.com/FoundryAI/python-semantic-release/commit/b8efd5a6249c79c8378bffea3e245657e7094ec9))

### Documentation

- Remove old notes about trello board
  ([`7f50c52`](https://github.com/FoundryAI/python-semantic-release/commit/7f50c521a522bb0c4579332766248778350e205b))

- Update status badges
  ([`cfa13b8`](https://github.com/FoundryAI/python-semantic-release/commit/cfa13b8260e3f3b0bfcb395f828ad63c9c5e3ca5))

### Features

- Add support to finding previous version from tags if not using commit messages
  ([#68](https://github.com/FoundryAI/python-semantic-release/pull/68),
  [`6786487`](https://github.com/FoundryAI/python-semantic-release/commit/6786487ebf4ab481139ef9f43cd74e345debb334))
...
- Add --retry cli option ([#78](https://github.com/FoundryAI/python-semantic-release/pull/78),
  [`3e312c0`](https://github.com/FoundryAI/python-semantic-release/commit/3e312c0ce79a78d25016a3b294b772983cfb5e0f))
...
- Error when not in git repository
  ([#75](https://github.com/FoundryAI/python-semantic-release/pull/75),
  [`251b190`](https://github.com/FoundryAI/python-semantic-release/commit/251b190a2fd5df68892346926d447cbc1b32475a))
...
- Update call to upload to work with twine 1.9.1
  ([#72](https://github.com/FoundryAI/python-semantic-release/pull/72),
  [`8f47643`](https://github.com/FoundryAI/python-semantic-release/commit/8f47643c54996e06c358537115e7e17b77cb02ca))
...
- Update Twine ([#69](https://github.com/FoundryAI/python-semantic-release/pull/69),
  [`9f268c3`](https://github.com/FoundryAI/python-semantic-release/commit/9f268c373a932621771abbe9607b739b1e331409))
...
- Make changelog problems not fail whole publish
  ([`b5a68cf`](https://github.com/FoundryAI/python-semantic-release/commit/b5a68cf6177dc0ed80eda722605db064f3fe2062))

Can be fixed with changelog command later.

### Documentation

- Fix typo in cli.py docstring ([#64](https://github.com/FoundryAI/python-semantic-release/pull/64),
  [`0d13985`](https://github.com/FoundryAI/python-semantic-release/commit/0d139859cd71f2d483f4360f196d6ef7c8726c18))

### Features

- Add git hash to the changelog
  ([#65](https://github.com/FoundryAI/python-semantic-release/pull/65),
  [`628170e`](https://github.com/FoundryAI/python-semantic-release/commit/628170ebc440fc6abf094dd3e393f40576dedf9b))
...
- Can't get the proper last tag from commit history
  ([`5a0e681`](https://github.com/FoundryAI/python-semantic-release/commit/5a0e681e256ec511cd6c6a8edfee9d905891da10))
...
- Add option for choosing between versioning by commit or tag
  ([`c0cd1f5`](https://github.com/FoundryAI/python-semantic-release/commit/c0cd1f5b2e0776d7b636c3dd9e5ae863125219e6))

default versioning behaviour is commiting

- Don't use file to track version, only tag to commit for versioning
  ([`cd25862`](https://github.com/FoundryAI/python-semantic-release/commit/cd258623ee518c009ae921cd6bb3119dafae43dc))

- Get repo version from historical tags instead of config file
  ([`a45a9bf`](https://github.com/FoundryAI/python-semantic-release/commit/a45a9bfb64538efeb7f6f42bb6e7ede86a4ddfa8))
...
- Add search_parent_directories option to gitpython
  ([#62](https://github.com/FoundryAI/python-semantic-release/pull/62),
  [`8bf9ce1`](https://github.com/FoundryAI/python-semantic-release/commit/8bf9ce11137399906f18bc8b25698b6e03a65034))
...
- Refactoring cli.py to improve --help and error messages
  ([`c79fc34`](https://github.com/FoundryAI/python-semantic-release/commit/c79fc3469fb99bf4c7f52434fa9c0891bca757f9))

- Add git fetch to frigg after success
  ([`74a6cae`](https://github.com/FoundryAI/python-semantic-release/commit/74a6cae2b46c5150e63136fde0599d98b9486e36))

- Make tag parser work correctly with breaking changes
  ([`9496f6a`](https://github.com/FoundryAI/python-semantic-release/commit/9496f6a502c79ec3acb4e222e190e76264db02cf))
...
- Add info about trello board in readme
  ([`5229557`](https://github.com/FoundryAI/python-semantic-release/commit/5229557099d76b3404ea3677292332442a57ae2e))

- Update info about releases in contributing.md
  ([`466f046`](https://github.com/FoundryAI/python-semantic-release/commit/466f0460774cad86e7e828ffb50c7d1332b64e7b))

- Add info about correct commit guidelines
  ([`af35413`](https://github.com/FoundryAI/python-semantic-release/commit/af35413fae80889e2c5fc6b7d28f77f34b3b4c02))

- Fix badges in readme
  ([`7f4e549`](https://github.com/FoundryAI/python-semantic-release/commit/7f4e5493edb6b3fb3510d0bb78fcc8d23434837f))

### Features

- Add ci checks for circle ci
  ([`151d849`](https://github.com/FoundryAI/python-semantic-release/commit/151d84964266c8dca206cef8912391cb73c8f206))
...
- Move code around a bit to make flake8 happy
  ([`41463b4`](https://github.com/FoundryAI/python-semantic-release/commit/41463b49b5d44fd94c11ab6e0a81e199510fabec))
...
- **configuration**: Fix typo in setup.cfg section
  ([`725d87d`](https://github.com/FoundryAI/python-semantic-release/commit/725d87dc45857ef2f9fb331222845ac83a3af135))
...
- Add ci_checks for Frigg CI
  ([`577c374`](https://github.com/FoundryAI/python-semantic-release/commit/577c374396fe303b6fe7d64630d2959998d3595c))
...
- Add requests as dependency
  ([`4525a70`](https://github.com/FoundryAI/python-semantic-release/commit/4525a70d5520b44720d385b0307e46fae77a7463))
...
- Add step by step guide for configuring travis ci
  ([`6f23414`](https://github.com/FoundryAI/python-semantic-release/commit/6f2341442f61f0284b1119a2c49e96f0be678929))

- Remove duplicate readme
  ([`42a9421`](https://github.com/FoundryAI/python-semantic-release/commit/42a942131947cd1864c1ba29b184caf072408742))

It was created by pandoc earlier when the original readme was written in markdown.

- Add note about node semantic release
  ([`0d2866c`](https://github.com/FoundryAI/python-semantic-release/commit/0d2866c528098ecaf1dd81492f28d3022a2a54e0))

- Move automatic-releases to subfolder
  ([`ed68e5b`](https://github.com/FoundryAI/python-semantic-release/commit/ed68e5b8d3489463e244b078ecce8eab2cba2bb1))

- Add documentation for configuring on CI
  ([`7806940`](https://github.com/FoundryAI/python-semantic-release/commit/7806940ae36cb0d6ac0f966e5d6d911bd09a7d11))

### Features

- Add checks for semaphore
  ([`2d7ef15`](https://github.com/FoundryAI/python-semantic-release/commit/2d7ef157b1250459060e99601ec53a00942b6955))
...
- Remove " from git push command
  ([`031318b`](https://github.com/FoundryAI/python-semantic-release/commit/031318b3268bc37e6847ec049b37425650cebec8))

### Documentation

- Convert readme to rst
  ([`e8a8d26`](https://github.com/FoundryAI/python-semantic-release/commit/e8a8d265aa2147824f18065b39a8e7821acb90ec))

### Features

- Checkout master before publishing
  ([`dc4077a`](https://github.com/FoundryAI/python-semantic-release/commit/dc4077a2d07e0522b625336dcf83ee4e0e1640aa))

Related to #39

- Add author in commit
  ([`020efaa`](https://github.com/FoundryAI/python-semantic-release/commit/020efaaadf588e3fccd9d2f08a273c37e4158421))
...
- Add travis environment checks
  ([`f386db7`](https://github.com/FoundryAI/python-semantic-release/commit/f386db75b77acd521d2f5bde2e1dde99924dc096))
...
- Do git push and git push --tags instead of --follow-tags
  ([`8bc70a1`](https://github.com/FoundryAI/python-semantic-release/commit/8bc70a183fd72f595c72702382bc0b7c3abe99c8))
...
- Change build badge
  ([`0dc068f`](https://github.com/FoundryAI/python-semantic-release/commit/0dc068fff2f8c6914f4abe6c4e5fb2752669159e))

### Documentation

- Update docstrings for generate_changelog
  ([`987c6a9`](https://github.com/FoundryAI/python-semantic-release/commit/987c6a96d15997e38c93a9d841c618c76a385ce7))
...
- Only list commits from the last version tag
  ([`191369e`](https://github.com/FoundryAI/python-semantic-release/commit/191369ebd68526e5b1afcf563f7d13e18c8ca8bf))

Fixes #28

- Add pandoc to travis settings
  ([`17d40a7`](https://github.com/FoundryAI/python-semantic-release/commit/17d40a73062ffa774542d0abc0f59fc16b68be37))
...
- Downgrade twine to version 1.5.0
  ([`66df378`](https://github.com/FoundryAI/python-semantic-release/commit/66df378330448a313aff7a7c27067adda018904f))

- Add missing parameters to twine.upload
  ([`4bae22b`](https://github.com/FoundryAI/python-semantic-release/commit/4bae22bae9b9d9abf669b028ea3af4b3813a1df0))

- Push to master by default
  ([`a0bb023`](https://github.com/FoundryAI/python-semantic-release/commit/a0bb023438a1503f9fdb690d976d71632f19a21f))

- Better filtering of github token in push error
  ([`9b31da4`](https://github.com/FoundryAI/python-semantic-release/commit/9b31da4dc27edfb01f685e6036ddbd4c715c9f60))

- Make sure the github token is not in the output
  ([`55356b7`](https://github.com/FoundryAI/python-semantic-release/commit/55356b718f74d94dd92e6c2db8a15423a6824eb5))

### Features

- Add support for environment variables for pypi credentials
  ([`3b383b9`](https://github.com/FoundryAI/python-semantic-release/commit/3b383b92376a7530e89b11de481c4dfdfa273f7b))
...
- Add requirements to manifest
  ([`ed25ecb`](https://github.com/FoundryAI/python-semantic-release/commit/ed25ecbaeec0e20ad3040452a5547bb7d6faf6ad))

- **pypi**: Add sdist as default in addition to bdist_wheel
  ([`a1a35f4`](https://github.com/FoundryAI/python-semantic-release/commit/a1a35f43175187091f028474db2ebef5bfc77bc0))
...
- **deps**: Use one file for requirements
  ([`4868543`](https://github.com/FoundryAI/python-semantic-release/commit/486854393b24803bb2356324e045ccab17510d46))

### Features

- **git**: Add push to GH_TOKEN@github-url
  ([`546b5bf`](https://github.com/FoundryAI/python-semantic-release/commit/546b5bf15466c6f5dfe93c1c03ca34604b0326f2))

- **angular-parser**: Remove scope requirement
  ([`90c9d8d`](https://github.com/FoundryAI/python-semantic-release/commit/90c9d8d4cd6d43be094cda86579e00b507571f98))
...
- **pypi**: Add option to disable pypi upload
  ([`f5cd079`](https://github.com/FoundryAI/python-semantic-release/commit/f5cd079edb219de5ad03a71448d578f5f477da9c))
...
- **errors**: Add exposing of errors in package
  ([`3662d76`](https://github.com/FoundryAI/python-semantic-release/commit/3662d7663291859dd58a91b4b4ccde4f0edc99b2))

- **version**: Parse file instead for version
  ([`005dba0`](https://github.com/FoundryAI/python-semantic-release/commit/005dba0094eeb4098315ef383a746e139ffb504d))
...
- **parser**: Add tag parser
  ([`a7f392f`](https://github.com/FoundryAI/python-semantic-release/commit/a7f392fd4524cc9207899075631032e438e2593c))
...
- **github**: Fix property calls
  ([`7ecdeb2`](https://github.com/FoundryAI/python-semantic-release/commit/7ecdeb22de96b6b55c5404ebf54a751911c4d8cd))
...
- **hvcs**: Make Github.token an property
  ([`37d5e31`](https://github.com/FoundryAI/python-semantic-release/commit/37d5e3110397596a036def5f1dccf0860964332c))

### Documentation

- **readme**: Update readme with information about the changelog command
  ([`56a745e`](https://github.com/FoundryAI/python-semantic-release/commit/56a745ef6fa4edf6f6ba09c78fcc141102cf2871))

- **parsers**: Add documentation about commit parsers
  ([`9b55422`](https://github.com/FoundryAI/python-semantic-release/commit/9b554222768036024a133153a559cdfc017c1d91))

- **api**: Update apidocs
  ([`6185380`](https://github.com/FoundryAI/python-semantic-release/commit/6185380babedbbeab2a2a342f17b4ff3d4df6768))
...
- **cli**: Fix call to generate_changelog in publish
  ([`5f8bce4`](https://github.com/FoundryAI/python-semantic-release/commit/5f8bce4cbb5e1729e674efd6c651e2531aea2a16))
...
- **history**: Fix issue in get_previous_version
  ([`f961786`](https://github.com/FoundryAI/python-semantic-release/commit/f961786aa3eaa3a620f47cc09243340fd329b9c2))
...
- **cli**: Fix check of token in changelog command
  ([`cc6e6ab`](https://github.com/FoundryAI/python-semantic-release/commit/cc6e6abe1e91d3aa24e8d73e704829669bea5fd7))

- **github**: Fix the github releases integration
  ([`f0c3c1d`](https://github.com/FoundryAI/python-semantic-release/commit/f0c3c1db97752b71f2153ae9f623501b0b8e2c98))

- **history**: Fix changelog generation
  ([`f010272`](https://github.com/FoundryAI/python-semantic-release/commit/f01027203a8ca69d21b4aff689e60e8c8d6f9af5))
...
- **cli**: Add the possibility to repost the changelog
  ([`4d028e2`](https://github.com/FoundryAI/python-semantic-release/commit/4d028e21b9da01be8caac8f23f2c11e0c087e485))
...
- **cli**: Change output indentation on changelog
  ([`2ca41d3`](https://github.com/FoundryAI/python-semantic-release/commit/2ca41d3bd1b8b9d9fe7e162772560e3defe2a41e))

- **history**: Support unexpected types in changelog generator
  ([`13deacf`](https://github.com/FoundryAI/python-semantic-release/commit/13deacf5d33ed500e4e94ea702a2a16be2aa7c48))

- **history**: Fix regex in angular parser
  ([`974ccda`](https://github.com/FoundryAI/python-semantic-release/commit/974ccdad392d768af5e187dabc184be9ac3e133d))

This fixes a problem where multiline commit messages where not correctly parsed.

- **history**: Fix level id's in angular parser
  ([`2918d75`](https://github.com/FoundryAI/python-semantic-release/commit/2918d759bf462082280ede971a5222fe01634ed8))

### Features

- **publish**: Add publishing of changelog to github
  ([`74324ba`](https://github.com/FoundryAI/python-semantic-release/commit/74324ba2749cdbbe80a92b5abbecfeab04617699))

- **github**: Add github release changelog helper
  ([`da18795`](https://github.com/FoundryAI/python-semantic-release/commit/da187951af31f377ac57fe17462551cfd776dc6e))

- **history**: Add markdown changelog formatter
  ([`d77b58d`](https://github.com/FoundryAI/python-semantic-release/commit/d77b58db4b66aec94200dccab94f483def4dacc9))

- **cli**: Add command for printing the changelog
  ([`336b8bc`](https://github.com/FoundryAI/python-semantic-release/commit/336b8bcc01fc1029ff37a79c92935d4b8ea69203))

Usage: `semantic_release changelog`

- **history**: Add generate_changelog function
  ([`347f21a`](https://github.com/FoundryAI/python-semantic-release/commit/347f21a1f8d655a71a0e7d58b64d4c6bc6d0bf31))
...
- **history**: Set angular parser as the default
  ([`c2cf537`](https://github.com/FoundryAI/python-semantic-release/commit/c2cf537a42beaa60cd372c7c9f8fb45db8085917))
...
- **settings**: Add loading of current parser
  ([`7bd0916`](https://github.com/FoundryAI/python-semantic-release/commit/7bd0916f87a1f9fe839c853eab05cae1af420cd2))

- **history**: Add angular parser
  ([`91e4f0f`](https://github.com/FoundryAI/python-semantic-release/commit/91e4f0f4269d01b255efcd6d7121bbfd5a682e12))
